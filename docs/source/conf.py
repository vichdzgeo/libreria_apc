...
htmlhelp_basename = 'LibreriaPython-Qgis218LANCIS-APCdoc'
...
man_pages = [
    (master_doc, 'libreriapython-qgis218lancis-apc', 'Libreria Python-Qgis2.18 LANCIS-APC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LibreriaPython-Qgis218LANCIS-APC', 'Libreria Python-Qgis2.18 LANCIS-APC Documentation',
     author, 'LibreriaPython-Qgis218LANCIS-APC', 'One line description of project.',
     'Miscellaneous'),
]
